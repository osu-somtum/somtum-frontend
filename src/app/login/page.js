            ...
            <main className="flex flex-col gap-8 row-start-2 items-center w-full">
                <div className="h-full w-auto border rounded-lg shadow bg-gray-900/50 border-gray-700/50 p-8">
                    <div className="flex flex-col gap-8 row-start-2 items-center p-4">
                        <p5 className="text-3xl font-bold text-white mb-8">Login</p5>
                        <form className="flex flex-col gap-4 w-full max-w-md px-4">
                            ...
                            <input
                                ...
                                required
                            />
                            <p className="text-sm text-white">Don't have an account? <a className="text-blue-400" href="/register">Register Here.</a></p>
                            <button type="submit" className="bg-slate-500/50 text-white p-2 rounded-md hover:bg-slate-700/50 transition-colors">
                                Login
                            </button>
                            <button type="submit" className="bg-slate-500/50 text-white p-2 rounded-md hover:bg-slate-700/50 transition-colors">
                                Forgot Password
